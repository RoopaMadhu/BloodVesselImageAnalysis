function [] = ELSA_3segmentCellsV4_Noconvhullseeds(data,MovieNum,checkInterval,tvec,seedesize,maskesize)
...
% 12/05/2012 Tim Vanderleest (modified)
% 12/01/2019 Roopa Madhu (modified)
...
% data_ecad = (load('../Channel2/dataimglist'));
% list_ecad = data_ecad.data.ImageFileList;
% data_dapi = load('../Channel1/dataimglist.mat');
% list_dapi = data_dapi.data.ImageFileList;
...
%         image = mat2gray(imread(list{t}) + imread(list_ecad{t}) - imread(list_dapi{t}));
